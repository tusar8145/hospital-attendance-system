...
let tableName='ccpm'
let headingTitle='CCPM'
let keyConfig=[
  {name:'dpc', type:'String', header:'DPC Code', edit:1, validate:{required:1}, xlsx:'診断群分類番号' },
  {name:'ccpm_group', type:'String', header:'CCPM Group', edit:1, validate:{required:1},   xlsx:'CCPM支払分類' },
