...
const SearchForm = lazy(() => import('../../shared-components/search-input/SearchForm'));
...
function Search() {
	...
	const [textUpload, setTextUpload] = useState('Search');
		...
		<Root
			...
			content={
				<div className="flex flex-col items-center p-24 sm:p-40 container">
					...
					<SearchForm textUpload={textUpload} enableUpload={handleActionFromSearch} globalFilter={handleSetGlobalFilter} txt={"Write classification/medical practice name/receipt code & press Enter"}/>
